...
import { CompetitionCard, GameCard, TeamCard, UserDashboardData } from "../../models/app.interface";
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, TeamCardComponent, NextGamesComponent, FooterComponent, CompetitionCardComponent, RouterLink],
...
export class UserDashboardComponent {
  ...
  teams: TeamCard[] = [ { id: 1, name: 'Ace Masters', sport_id: 1, sport_name: 1, image: 'assets/images/team-default.png', gender: 'mixed' }, { id: 2, name: 'Baseline Kings', sport_id: 1, sport_name: 1, image: 'assets/images/team-default.png', gender: 'mixed' } ];

  competitions: CompetitionCard[] = [ { id: 1, name: 'Liga Club Tenis', image: null, sport_id: 1, sport_name: 1, type: 'league', level: 3, start_date: '2025-01-15', location: 'Club Deportivo Central', is_open: true }, { id: 2, name: 'Torneo de Invierno', image: null, sport_id: 1, sport_name: 1, type: 'tournament', level: 3, start_date: '2025-02-01', location: 'Real Club de Tenis', is_open: false } ];
